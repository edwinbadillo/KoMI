...
const Icon = ({ className }) => (
  ...
  >
    <path
      ...
      style={{ fillRule: 'evenodd', fill: '#02a9ff' }}
    />
    <path
      d="M54.365 34.792L18.331 137.351h27.996l6.098-17.74h30.49l5.96 17.74h27.857L80.836 34.792H54.365zm4.435 62.09l8.731-28.412 9.563 28.412H58.8z"
      style={{ fillRule: 'evenodd', fill: '#fefefe' }}
    />
  </svg>
